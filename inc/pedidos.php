            ...
            <div class="modal-content panel-success">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="gs_cantidad" class="form-control" min="1" max="10" step="1" value="1" required>
                    </div>
                </div>
                <div class="modal-footer">
        ...
        <form role="form" id="formCancelarPedido">
            <div class="modal-content panel-danger">
                ...
                <div class="modal-body text-center">
                    <strong>¿Estás segudo de cancelar el pedido?</strong>
    ...
    <div class="modal-dialog" role="document">
        <form role="form" id="formFacturarPedido">
            <div class="modal-content panel-warning">
                <div class="modal-header panel-heading">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Pagar Pedido</h4>
                </div>
                <div class="modal-body text-center">
                    <strong>¿Estás segudo de Pagar el pedido?</strong>
                    <input type="hidden" id="idpedcab_facturar" value="0">
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning pull-left">Pagar</button>
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </form>
...
<div class="modal fade" id="myModalImprimirPedido" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form role="form" id="formImprimirPedido">
            <div class="modal-content panel-success">
                <div class="modal-header panel-heading">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body text-center">
                    <strong>¿Estás segudo de imprimir el comprobante?</strong>
                    <input type="hidden" id="idpedcab_imprimir" value="0">
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success pull-left">Imprimir</button>
                    <button type="button" class="btn btn-default pull-right" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </form>
        ...
        <div class="col-md-12">
            ...
            <form role="form" id="formCarrito">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="cliente">N° Documento</label>
                            <input type="text" id="cliente" class="form-control" value="" disabled>
                        </div>
                        <div class="form-group">
                            <label for="direccion">Dirección</label>
                            <textarea maxlength="200" id="direccion" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
<script>
    function printDiv(pedido_detalle){
        var contenido = document.getElementById(pedido_detalle).innerHTML;
